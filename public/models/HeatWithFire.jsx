...
export function Model(props) {
  const { nodes, materials } = useGLTF('/HeatWithFire.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.ArmHandle_low.geometry} material={materials['Material.004']} position={[0.416, 0.132, 0.044]} rotation={[Math.PI / 2, 0, -1.646]} scale={0.181} />
