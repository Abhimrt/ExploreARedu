        ...
        <div className='relative h-auto overflow-x-hidden'>
            ...
            <main className='w-screen h-auto pt-[420px] mb-5  p-5 '>
                ...
                <div className='w-screen center flex-wrap'>
                    <Link href="/class/11/prac1/3d"><button onClick={() => synthesis.cancel()} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">3D Model</button></Link>
                </div>
            </main>
        </div>
    )
